<script lang="ts">
  ...
  function handleLogin(event: CustomEvent<{ email: string; password: string }>) {
  ...
  <div class="w-full max-w-md">
    <Card class="p-8 shadow-xl border border-gray-200 dark:border-gray-700">
      ...
      <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <a href="/auth/register" class="text-primary-600 dark:text-primary-400 hover:underline font-medium">Create one</a>
      </p>
    </Card>
  </div>
</div>