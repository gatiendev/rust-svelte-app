...
│   │   ├── jwt_test.go                     # Unit tests for JWT helpers
...
│   │   ├── auth_test.go                     # Handler tests with mocked repositories
│   │   └── routes.go                        # Gin route setup
│   ├── middleware/
│   │   ├── logger.go                        # Gin request logging middleware
│   │   ├── logger_test.go                    # Tests for logger middleware
│   │   ├── requestid.go                      # Gin request ID middleware
│   │   └── requestid_test.go                  # Tests for request ID middleware
│   ├── models/
...
│       ├── user_test.go                       # Integration tests for user repository (requires database)
│       ├── token.go                           # Refresh token repository (pgx implementation)
│       └── token_test.go                       # Integration tests for token repository (requires database)
...
- Go 1.26+ (only if you want to run locally without Docker)
