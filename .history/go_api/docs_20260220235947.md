# Go Authentication System with JWT, PostgreSQL, and Gin Framework
...
│   └── repository/
│       ├── user.go                     # User repository (CRUD)
│       └── token.go                     # Refresh token repository
...
### 14.2 Migrations Fail with "first .: file does not exist"
...
### 14.3 "bcrypt: password length exceeds 72 bytes"
...
### 14.4 Cookies Not Being Set/Sent
...
### 14.5 Air Not Triggering Rebuild
...
### 14.6 Gin Middleware Type Errors
...
### 14.7 Duration in Logs Shows as Number, Not String
...
### 15.3 Switching to a Different Database

Replace the `lib/pq` driver with the appropriate one (e.g., `pgx` for PostgreSQL, or drivers for MySQL, SQLite). Adjust connection strings and dialect if needed.
