...
use actix_web::{web, HttpResponse, HttpRequest, Responder}; // <-- add HttpRequest
...
pub async fn login(
    ...
    http_req: HttpRequest,                 // <-- new parameter
) -> impl Responder {
    ...
    .expect("Failed to set identity");   // or proper error handling
