...
use actix_web::{cookie::Key, middleware::Logger, web, App, HttpServer}; // <-- added Logger
...
async fn main() -> anyhow::Result<()> {
    // Initialize logger (must be inside main)
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .wrap(Logger::new("%r %s %Dms")) // Logs each request
            .wrap(
